...
/// The official Clever 1 rules — ONE source shared by the regular entry and
/// the "(v3)" landscape-layout experiment, so the text is never duplicated.
func cleverRulesDocument() -> RulesDocument {
    RulesDocument(
